...
const IcoSphere::VertexList IcoSphere::sVertices = {{-X, N, Z}, {X, N, Z},   {-X, N, -Z}, {X, N, -Z}, {N, Z, X},  {N, Z, -X},
                                                    {N, -Z, X}, {N, -Z, -X}, {Z, X, N},   {-Z, X, N}, {Z, -X, N}, {-Z, -X, N}};

const IcoSphere::TriangleList IcoSphere::sTriangles = {{1, 4, 0}, {4, 9, 0},  {4, 5, 9},  {8, 5, 4},  {1, 8, 4},  {1, 10, 8}, {10, 3, 8},
...
IcoSphere::Index IcoSphere::vertex_for_edge(Lookup& lookup, VertexList& vertices, Index first, Index second)
{
