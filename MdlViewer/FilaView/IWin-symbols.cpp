...
class IWin_IWinIWin : public IWin { public: IWin_IWinIWin(): IWin() {}; unsigned long long handle() { return {}; } void exec(bool) {} IView* view(int) { return {}; } int load_model(const char*, float) { return {}; } int operator_s(const char*, int) { return {}; }  };
extern "C" __declspec(dllexport) void IWin_IWin(void* __instance) { ::new (__instance) IWin_IWinIWin(); }
class IWin_IWin___1__S_IWinIWin : public IWin { public: IWin_IWin___1__S_IWinIWin(const IWin& _0): IWin(_0) {}; unsigned long long handle() { return {}; } void exec(bool) {} IView* view(int) { return {}; } int load_model(const char*, float) { return {}; } int operator_s(const char*, int) { return {}; }  };
