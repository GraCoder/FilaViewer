...
namespace FilaView
{
    ...
    public unsafe partial class Node : IDisposable
    {
        ...
        public partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("FilaView.dll", EntryPoint = "?get_rd@Node@@QEAAPEAVRDNode@@XZ", CallingConvention = __CallingConvention.Cdecl)]
        ...
        protected global::FilaView.RDNode Rd
        {
            get
            {
                var __result0 = global::FilaView.RDNode.__GetOrCreateInstance(((__Internal*)__Instance)->_rd, false);
                return __result0;
            }

            set
            {
                ((__Internal*)__Instance)->_rd = value is null ? __IntPtr.Zero : value.__Instance;
            }
        }
